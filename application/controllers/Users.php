...
class Users extends CI_Controller
{
    ...
    function data()
    {
        ...
        $columns = array(
            ...
            array('db' => 'id_level_user', 'dt' => 'id_level_user'),
    ...
    function edit()
    {
        if (isset($_POST['submit'])) {
            ...
            $data['user']  = $this->db->get_where('x_tbluser', array('id_user' => $id_user))->row_array();
    ...
    function chek_akses($level_user, $id_menu)
    {
        ...
        $chek = $this->db->get_where('x_user_rule', $data);
        if ($chek->num_rows() > 0) {
            echo "checked";
        }
    }
