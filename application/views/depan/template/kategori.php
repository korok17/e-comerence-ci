    ...
    <div class="container">
                ...
                <div class="products_bar d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-lg-start justify-content-center">
                    <div class="products_bar_links">
                        <ul class="d-flex flex-row align-items-start justify-content-start">
                            <li class="active"><a href="#">Parfum</a></li>
                            <li><a href="#">Alkohol</a></li>
                            <li><a href="#">Botol</a></li>
                            <li><a href="<?= base_url('bibit') ?>">Bibit</a></li>
                        </ul>
                    </div>
        ...
        <div class="row products_row products_container grid">
            ...
            <div class="col-xl-4 col-md-6 grid-item new">
                <div class="product">
                    <div class="product_image"><img src="<?= base_url('assets/depan/') ?>images/subimage3.jpg" alt=""></div>
                    <div class="product_content">
                        <div class="product_info d-flex flex-row align-items-start justify-content-start">
                            <div>
                                <div>
                                    <div class="product_name"><a href="<?= base_url('product') ?>">Dmiqa perfume
                                            Premium</a></div>
                                    <div class="product_category">In <a href="<?= base_url('category') ?>">Category</a>
                                    </div>
                                </div>
                            </div>
