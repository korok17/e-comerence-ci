    ...
    <div class="container">
        ...
        <div class="login-content">
            <form action="index.html">
                <img src="<?= base_url('assets/depan/login/') ?>img/avatar.svg">
                <h2 class="title" style="font-family:arial; margin: 20px 0px; font-size: 15px;">
                    <p style="font-size: 20px; color:deepskyblue;">Don't panic,</p>
                    your account is safe try to reset your password
                </h2>
                ...
                <a href="login.html" style="float: left; font-size: 20px;">
