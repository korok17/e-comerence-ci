				...
				f = function () {
					...
					return n.collapse = function () {
						...
						return this.each(function () {
							...
							i || (i = new t(e(this), i), e(this).data("lte.widget", "string" == typeof n ? i : n)), "string" == typeof n && n.match(/collapse|expand|remove|toggle|toggleMaximize/) ? i[n]() : "object" == typeof n && i._init(e(this))
						})
					}, t
				}();
