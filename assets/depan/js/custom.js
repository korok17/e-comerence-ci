...
6. Atok kau nyescrolling di javascript
...
$(window).scroll(function() {
	...
	// about scrolling //
		...
		if( wScroll > $('.visimisi').offset().top - 150 ){
			$('.visimisi .kesatuan').each(function(i) {
				setTimeout(function(){
					$('.visimisi .kesatuan').eq(i).addClass('Muncul');
			}, 300 * (i+1));
...
7. bapak kau nyescrolling di javascript
